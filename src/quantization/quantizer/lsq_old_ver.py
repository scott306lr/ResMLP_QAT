...
class ResActLSQ(Module):
    def __init__(self, from_bit=32, to_bit=8, mult_bit=16, training=True, return_fp=False, batch_init=20):
    ...
    def forward(self, x, a_s=None, res_x=None, res_a_s=None):
        ...
        if self.training:
            ...
            if self.return_fp: # last layer, connecting back to fp calculation
