...
class Q_ResMLP24(nn.Module):
    ...
    def __init__(self, model):
        ...
        self.blocks = nn.ModuleList([QLayer_Block(model.blocks[i], layer=i, res_to_bit=8) for i in range(24)])
